        ...
        if (j.contains("models"))
        {
            for (auto &modelJson : j.at("models"))
            {
                ...
                if (modelJson.contains("transform"))
                {
                    ...
                    {
                        scale =
                            glm::scale(glm::mat4(1.f), transformJson.at("scale").get<glm::vec3>());
                    }
                    ...
                    if (transformJson.contains("rotation"))
                    {
                        ...
                        rotation =
                            glm::rotate(glm::mat4(1.f), rotationJson.at("degrees").get<float>(),
                    ...
                    if (transformJson.contains("translation"))
                    {
                        translation = glm::translate(
                            glm::mat4(1.f), transformJson.at("translation").get<glm::vec3>());
                    }
                }
