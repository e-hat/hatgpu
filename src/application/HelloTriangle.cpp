...
HelloTriangle::QueueFamilyIndices HelloTriangle::findQueueFamilies(const VkPhysicalDevice &device)
{
...
bool HelloTriangle::isDeviceSuitable(const VkPhysicalDevice &device)
{
